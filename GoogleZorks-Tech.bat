...
timeout /t 5
start "" "https://www.google.nl/search?num=100&newwindow=1&q=site:%1+%SearchString1%&filter=0"
...
timeout /t 5
start "" "https://www.google.nl/search?num=100&newwindow=1&q=%%22%1%%22+-site:%1+%SearchString1%&filter=0"
