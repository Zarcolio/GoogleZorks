...
IF NOT "%2"=="" SET ExtraOrSearch=%%7C+%%22%2%%22+
...
SET SearchStringSec=%%22CyberArk%%22+%%7C+%%22Cloudflare%%22+%%7C+%%22ZScaler%%22+%%7C+%%22Splunk%%22+%%7C+%%22LogRhythm%%22+%%7C+%%22QRadar%%22+%%7C+%%22ArcSight%%22+%%22Sentinel%%22+%%7C+%%22Palo+Alto%%22+%%7C+%%22Fortinet%%22+%%7C+%%22Okta%%22+%%7C+%%22Akamai%%22+%%7C+%%22Check+Point%%22+%%7C+%%22CheckPoint%%22+%%7C+%%22Pulse+Secure%%22+%%7C+%%22PulseSecure%%22
...
TIMEOUT /t 5
START "" "https://www.google.nl/search?num=100&newwindow=1&q=%%22%1%%22+%ExtraOrSearch%-site:%1+%SearchStringDb%&filter=0"

TIMEOUT /t 5
START "" "https://www.google.nl/search?num=100&newwindow=1&q=%%22%1%%22+%ExtraOrSearch%-site:%1+%SearchStringOs%&filter=0"

TIMEOUT /t 5
START "" "https://www.google.nl/search?num=100&newwindow=1&q=%%22%1%%22+%ExtraOrSearch%-site:%1+%SearchStringSupp%&filter=0"

TIMEOUT /t 5
START "" "https://www.google.nl/search?num=100&newwindow=1&q=%%22%1%%22+%ExtraOrSearch%-site:%1+%SearchStringNet%&filter=0"

TIMEOUT /t 5
START "" "https://www.google.nl/search?num=100&newwindow=1&q=%%22%1%%22+%ExtraOrSearch%-site:%1+%SearchStringCloud%&filter=0"

TIMEOUT /t 5
START "" "https://www.google.nl/search?num=100&newwindow=1&q=%%22%1%%22+%ExtraOrSearch%-site:%1+%SearchStringVirt%&filter=0"

TIMEOUT /t 5
START "" "https://www.google.nl/search?num=100&newwindow=1&q=%%22%1%%22+%ExtraOrSearch%-site:%1+%SearchStringApp%&filter=0"

TIMEOUT /t 5
START "" "https://www.google.nl/search?num=100&newwindow=1&q=%%22%1%%22+%ExtraOrSearch%-site:%1+%SearchStringSec%&filter=0"
