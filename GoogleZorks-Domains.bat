...
timeout /t 10
start "" "https://www.google.nl/search?num=100&filter=0&q=site:pastebin.com+|site:pastelink.net+|site:pastefs.com+%%22%1%%22&filter=0"
timeout /t 10
start "" "https://www.google.nl/search?num=100&filter=0&q=site:github.com+|site:site:gitlab.com+|site:bitbucket.org+%%22%1%%22&filter=0"
...
rem start "" "https://www.google.nl/search?q=site:%1+ext:sql+|ext:dbf+|ext:mdb+|++ext:db+ext:bkf+|ext:bkp+|ext:bak+|ext:old+|ext:backup+ext:log&filter=0"
